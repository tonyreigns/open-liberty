...
IBM-API-Package: io.opentracing;                         type="third-party", \
                 ...
                 io.opentracing.log;                     type="third-party", \
    			 io.opentracing.util;                    type="third-party", \
    			 io.opentracing.noop;                    type="third-party", \
                 io.opentracing.contrib.tracerresolver;  type="third-party", \
...
=======
         com.ibm.websphere.appserver.thirdparty.opentracing.0.31.0;         location:="dev/api/third-party/,lib/"; mavenCoordinates="io.opentracing:opentracing-api:0.31.0", \
         com.ibm.websphere.appserver.thirdparty.opentracing.tracerresolver  location:="dev/api/third-party/,lib/"; mavenCoordinates="io.opentracing.contrib:opentracing-tracerresolver:0.1.5"
>>>>>>> Jaeger working prototype
