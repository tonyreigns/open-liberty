...
public class OpenTelemetryLogHandler implements SynchronousHandler {
    ...
    protected void activate(ComponentContext cc, Map<String, Object> configuration) {
        ...
        // Activate the variable registry service
    ...
    protected void deactivate(ComponentContext cc, int reason) {
        ...
        // Deactivate the variable registry service
    ...
    /*
     * Set the serverName and serverUserDir variables from the variable registry service reference.
     */
    private void setServerInfo(Map<String, Object> configuration) {
        // Set the server name
        this.serverName = variableRegistryServiceRef.getService().resolveString(VAR_WLPSERVERNAME);

        // Set the server user dir
        this.serverUserDir = variableRegistryServiceRef.getService().resolveString(VAR_WLPUSERDIR);
    }
    ...
    private void formatEvent(LogRecordBuilder builder, String source, Object event) {
        ...
        MpTelemetryLogMappingUtils.mapLibertyEventToOpenTelemetry(builder, event, eventType, this.serverName, this.serverUserDir);
    }
