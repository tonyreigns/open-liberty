...
public class FATOpentracing implements FATOpentracingConstants {
    ...
    public void verifyContiguousSpans(
        ...
        for ( int spanNo = actualSpanCount - expectedSpanCount; spanNo < actualSpanCount; spanNo++ ) {
            ...
            if ( initialTraceId == null ) {
                ...
                System.out.println(nextTraceId + " -- " + initialTraceId);
    ...
    public void verifyParents(
        ...
        for ( ParentCondition parentCondition : parentConditions ) {
            ...
            System.out.println("Printing veryifyParents2!");
            System.out.println(selectionText(parentCondition.childSelection));
...
//        System.setProperty("mp_opentracing_server_skip_pattern","/serviceApp/rest/testService/excludeTest?response=simple");
//        System.setProperty("mp_opentracing_server_skip_pattern","/serviceApp/rest/testService/excludeTest?response=simple");
//        System.setProperty("mp_opentracing_server_skip_pattern","http://localhost:${bvt.prop.HTTP_default}/serviceApp/rest/testService/excludeTest?response=absoluteUri");    //1
//        System.setProperty("mp_opentracing_server_skip_pattern","/serviceApp/rest/testService/excludeTest\\?response=regexTest[0-9]+ regex=true");
//        System.setProperty("mp_opentracing_server_skip_pattern","/serviceApp/rest/testService/excludeTest?response=wildcard*");
//        System.setProperty("mp_opentracing_server_skip_pattern","/serviceApp/rest/testService/getDelayed?delay=4&amp;response=nestedExcludeTest1*");
//        System.setProperty("mp_opentracing_server_skip_pattern","/serviceApp/rest/testService/excludeTest?response=incomingExcluded type=INCOMING");
//        System.setProperty("mp_opentracing_server_skip_pattern","/serviceApp/rest/testService/excludeTest?response=incomingIncluded type=OUTGOING");

                    //testExcludedPath("simple");
                     //testExcludedPath("wildcardTest");
                    //testExcludedPath("absoluteUri");  //works 1
       ...
       // testIncludedPath("wildcardInclude");
        ...
        //testNestedExcludePath("nestedExcludeTest1", 1, true);
                    //testExcludedPath("incomingExcluded");   //Works
    ...
    private void testExcludedPath(String param) throws Exception, UnsupportedEncodingException {
        ...
        System.out.println("COMPLETED SPANS!!");
        System.out.println(getCompletedSpans(GET_EXCLUDE_TEST_PATH).size());
        System.out.println("Param!!");
        System.out.println(param);
        System.out.println("Count!!");
        System.out.println(newCompletedSpansCount);
        System.out.println("COMPLETED SPANS!!Done");
    ...
    private void testNestedExcludePath(String param, int nestDepth, boolean excludingDelay4) throws Exception {
        ...
        int tailSize = excludingDelay4 ? 5 : 7;
          ...
          System.out.println("ExcludedTests!");
          System.out.println(completedSpans + " -- " + tailSize);
        verifyContiguousSpans(completedSpans, tailSize);
        ...
        if (excludingDelay4) {
            System.out.println("Printing veryifyParents!");
            System.out.println(completedSpans);
            System.out.println("Tailsize:");
            System.out.println(tailSize);
            System.out.println("#1");
            System.out.println(getNested1Condition);
            System.out.println("#2");
            System.out.println(getDelay2ClientCondition);
            System.out.println("#3");
            System.out.println(getDelay2ContainerCondition);
            System.out.println("#4");
            System.out.println(getDelay6ClientCondition);
            System.out.println("#5");
            System.out.println(getDelay6ContainerCondition);
