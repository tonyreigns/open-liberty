...
public class TelemetryMessagesTest extends FATServletClient {
    ...
    public void testTelemetryMessages() throws Exception {
        ...
        assertTrue("MPTelemetry did not log the correct log level", line.contains("INFO2"));
        ...
        assertTrue("MPTelemetry did not log server name field", line.contains("com.ibm.server_name=\"TelemetryMessageNoApp\""));
        assertTrue("MPTelemetry did not log server messageID field", line.contains("com.ibm.message_id=\"CWWKF0011I\""));
        assertTrue("MPTelemetry did not log server module field", line.contains("com.ibm.module=\"com.ibm.ws.kernel.feature.internal.FeatureManager\""));
        assertTrue("MPTelemetry did not log server sequence field", line.contains("com.ibm.sequence=\""));
        assertTrue("MPTelemetry did not log server type field", line.contains("com.ibm.type=\"liberty_message\""));
        assertTrue("MPTelemetry did not log server user_dir field", line.contains("com.ibm.user_dir="));
