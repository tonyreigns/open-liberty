...
public class TelemetryFFDCTest extends FATServletClient {
    ...
    public void testTelemetryMessages() throws Exception {
        ...
        assertTrue("FFDC Log levelwas not logged by MPTelemetry", logLevelLine != null);
        assertTrue("FFDC Exception.message was not logged by MPTelemetry", exceptionMessageLine != null);
        assertTrue("FFDC Exception.stacktrace was not logged by MPTelemetry", exceptionTraceLine != null);
        assertTrue("FFDC Exception.type was not logged by MPTelemetry", exceptionTypeLine != null);
